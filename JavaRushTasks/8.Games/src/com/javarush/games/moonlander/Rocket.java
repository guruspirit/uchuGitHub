...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        fire.add(ShapeMatrix.FIRE_DOWN_1);
        fire.add(ShapeMatrix.FIRE_DOWN_2);
        fire.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(fire);
        fire = new ArrayList<>();
        fire.add(ShapeMatrix.FIRE_SIDE_1);
        fire.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(fire);
        rightFire = new RocketFire(fire);
    }
